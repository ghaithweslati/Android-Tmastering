...
public class TachesActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                dateDebTach.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            dateDeb = format.parse(getIntent().getStringExtra("dateDeb"));
                            dateFin = format.parse(getIntent().getStringExtra("dateFin"));
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        module module = new module(Integer.parseInt(getIntent().getStringExtra("id")));
                        tachePlanifiee tachePlan = new tachePlanifiee(nomTach.getText().toString(),dateDebTach.getText().toString(),dateFinTach.getText().toString(),operateur,module);

                        if(verif()) {
                            new ajouter_tache(tachePlan).execute();
                            dialog.dismiss();
                        }
                    }
                });
    ...
    private class afficher_taches extends AsyncTask<Void, Void, String> {
        ...
        @Override
        protected void onPreExecute() {
            JSON_URL = "https://tmastering.000webhostapp.com/afficher_taches.php?id_module="+getIntent().getStringExtra("id");
        }
                ...
                do {
                    if (result != null) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String prenom = jo.getString("prenom");
                            module mod = new module(getIntent().getStringExtra("dateDeb"),getIntent().getStringExtra("dateFin"));

                            tacheAdapter.add(new tachePlanifiee(id,titre,dateDebPlan,dateFinPlan,new operateur(id_operateur,nom,prenom,image_profil),mod));
                        }
                        webView.loadUrl(
                                "https://tmastering.000webhostapp.com/gant_taches.php?id_module="+getIntent().getStringExtra("id"));

                    }
                } while (result == null);
            } catch (JSONException e) {
                Toast.makeText(getApplicationContext(), "Pas de tache dans ce module", Toast.LENGTH_LONG).show();
            }
        }
    }

    private class ajouter_tache extends AsyncTask<Void, Void, Void> {

        private tachePlanifiee tachePlan;

        public ajouter_tache(tachePlanifiee tachePlan) {
            this.tachePlan = tachePlan;
        }
    ...
    private void makeRequest(final tachePlanifiee tachePlan) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://tmastering.000webhostapp.com/ajouter_tache.php",
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("date_deb_plan", tachePlan.getDateDeb());
                map.put("date_fin_plan", tachePlan.getDateFin());
                map.put("titre",tachePlan.getTitre());
                map.put("id_operateur", String.valueOf(tachePlan.getOperateur().getId()));
                map.put("id_module", String.valueOf(tachePlan.getModule().getId()));
                return map;
            }
        };
